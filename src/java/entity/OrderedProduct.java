...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderedProduct.findByProductCatalogProductId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.productCatalogProductId = :productCatalogProductId")
...
public class OrderedProduct implements Serializable {
    ...
    @JoinColumn(name = "customer_order_order_id", referencedColumnName = "order_id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private CustomerOrder customerOrder;
    @JoinColumn(name = "product_catalog_product_id", referencedColumnName = "product_id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public OrderedProduct(int customerOrderOrderId, int productCatalogProductId) {
        this.orderedProductPK = new OrderedProductPK(customerOrderOrderId, productCatalogProductId);
    }
