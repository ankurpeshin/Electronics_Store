...
public class ShoppingCart {
     ...
     */
    public synchronized void addItem(ProductCatalog product) {

        boolean newItem = true;

        for (ShoppingCartItem scItem : items) {

            if (scItem.getProduct().getProductId().doubleValue() == product.getProductId().doubleValue()) {
     ...
     * @see ShoppingCartItem
     */
    public synchronized void update(ProductCatalog product, String quantity) {
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            ProductCatalog product = (ProductCatalog) scItem.getProduct();
